...
COPY requirements.txt . RUN pip install --no-cache-dir -r requirements.txt RUN pip install pyjwt==2.3.0 RUN pip install pyupbit RUN pip install --no-cache-dir tensorflow
