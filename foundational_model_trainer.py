...
# --- Constants ---
LOOKBACK_WINDOW = 50 DATA_PATH = "cache/preprocessed_data.pkl" LOG_DIR = "foundational_rl_tensorboard_logs/" MODEL_SAVE_PATH = "foundational_agent.zip" # Single model STATS_SAVE_PATH = "specialist_stats.json"

def train_foundational_agent(total_timesteps=100000): # Reduced for speed if os.path.exists(LOG_DIR): print(f"기존 로그 디렉토리 {LOG_DIR}를 삭제합니다.") shutil.rmtree(LOG_DIR) os.makedirs(LOG_DIR, exist_ok=True)
